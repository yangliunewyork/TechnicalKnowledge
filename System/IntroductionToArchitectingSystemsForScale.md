Please refer the original blog: http://lethain.com/introduction-to-architecting-systems-for-scale
I put the content here just in case the original url is not available any more.
...
![alt](http://lethain.com/static/blog/intro_arch/load_balance.png)
...
* from the user to your web servers
* from your web servers to an internal platform layer 
* from your internal platform layer to your database.
...
![alt](http://lethain.com/static/blog/intro_arch/app_cache.png)
...
![alt](http://lethain.com/static/blog/intro_arch/database_cache.png)
...
![alt] (http://lethain.com/static/blog/intro_arch/cdn.png)
...
![alt](http://lethain.com/static/blog/intro_arch/message_queue.png)
...
Does anyone know of recognized tools which solve this problem? I've seen many homebrew systems, but nothing clean and reusable. Sure, you can store the cronjobs in a Puppet config for a machine, which makes recovering from losing that machine easy, but it would still require a manual recovery, which is probably acceptable but not quite perfect.
...
![alt](http://lethain.com/static/blog/intro_arch/map_reduce.png)
...
![alt](http://lethain.com/static/blog/intro_arch/platform_layer.png)
