...
Other problems with those platforms is that they are not easy to use, or lack the metrics and feature our own team need. NewsHQ lets us choose whatever metrics we want to use, which is more effective because different teams and different projects need different types of metrics. Moreover, we can use a wide range of interactive charts and tubulars to display our metrics. And we won't get the flexibility from those platforms, they only offer predefined charts and tubulars.

##### NewsHQ enable regular monitoring
Last but not least, NewsHQ helps us monitor and track our servers/processe on regular basis, which we believe is important and bring big results. 
